...
func registerFlags(fs *flag.FlagSet) {
	...
	fs.Int("sync-interval", 60, "Interval in seconds to poll SD card for new recordings (default: 60s)")
	fs.Int("sdcard-sync-interval", 60, "Interval in seconds to poll SD card for new recordings (alias)")
