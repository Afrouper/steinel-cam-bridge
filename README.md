...
| `BRIDGE_PASS` / `BRIDGE_PASSWORD` | `-bridge-pass` *(oder `-bridge-password`)* | `""` | Optionales Passwort für den Zugangsschutz der Bridge (RTSP Digest/Basic, ONVIF HTTP Digest / WS-Security, REST API) |
